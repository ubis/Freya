...
func RegisterPackets() {
	...
	pk.Register(net.SKILLTOACTS, "SkillToActs", SkillToActs)
	pk.Register(net.NFY_SKILLTOACTS, "NotifySkillToActs", nil)
	pk.Register(net.CHANGESTYLE, "ChangeStyle", ChangeStyle)
	pk.Register(net.NFY_CHANGESTYLE, "NotifyChangeStyle", nil)
